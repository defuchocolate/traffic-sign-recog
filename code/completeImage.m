...
% Completes the road signs that have a cross across them (prohibitory)
...
dilated(dilated == 1) = 255;

x = cat(3, dilated, dilated, dilated);
...
if strcmpi(reply, 'Yes')
    ...
    for k = 1 : numberOfBlobs           % Loop through all blobs.
        ...
        if(blobArea>10)
            ...
            subImage = imcrop(x, thisBlobsBoundingBox);
